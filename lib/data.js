 ...
 */
var arrayDeepRemoveList = function arrayDeepRemoveList(array, keys) {
    return deepClone(array).reduce(function (pre, cur) {
...
function getFilerArrayObjectString(option) {
    ...
    arr1.forEach(function (item, index) {
        arr2.forEach(function (ele, ji) {
            var brr = Object.create({});
            if (item.toString() === ele[key].toString()) {
                filer.map(function (item) {
                    return Object.assign(brr, _defineProperty({}, item, ele[item]));
                });
                arr.push(brr);
            }
        });
...
function getSmallObjectString(option) {
    ...
    var arr = [];
    arr1.forEach(function (item, index) {
        var isIn = arr2.some(function (cur) {
            return item[key].toString() == cur;
        });
...
exports.default = {
    ...
    getMergeObject: getMergeObject, getDeepObjKeysValue: getDeepObjKeysValue, flattenDeep: flattenDeep, deepClone: deepClone, arrayDeepRemoveList: arrayDeepRemoveList,
    getArrObjectString: getArrObjectString, getFilteraArrayList: getFilteraArrayList, getFilerArrayObjectString: getFilerArrayObjectString, getSmallObjectString: getSmallObjectString,
